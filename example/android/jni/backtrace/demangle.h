...
/* V3 ABI demangling entry points, defined in cp-demangle.c.  Callback
   ...
   return a string allocated by malloc on success, NULL on error.  */
	extern int
	 cplus_demangle_v3_callback(const char *mangled, int options, demangle_callbackref callback, void *opaque);

	extern char *cplus_demangle_v3(const char *mangled, int options);

	extern int
	 java_demangle_v3_callback(const char *mangled, demangle_callbackref callback, void *opaque);
...
/* This function takes a struct demangle_component tree and returns
   ...
   memory allocation error.  */
	...
	extern char *cplus_demangle_print(int options,
					  const struct demangle_component *tree, int estimated_length, size_t * p_allocated_size);
   ...
   corrupted.  On success, this function returns 1; on failure, 0.  */
	...
	extern int
	 cplus_demangle_print_callback(int options,
				       const struct demangle_component *tree, demangle_callbackref callback, void *opaque);
